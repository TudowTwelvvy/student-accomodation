      ...
      <div className='flex justify-between items-center mx-auto p-3'>
        ...
        <div className='hidden md:inline'>
          <form onSubmit={handleSubmit} className='flex items-center justify-center rounded-lg border-[2px] border-dark-blue h-7 ml-4 md:h-10 bg-dark-blue '>
            <input value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} type="text" placeholder='Search...' className='outline-none w-[80px] md:w-[300px] lg:w-[400px] h-full rounded-l-lg p-2' />
        ...
        <ul className='flex justify-center items-center gap-2 lg:gap-4 text-sm md:text-base mr-2 lg:mr-7'>
          <Link to='/'><li className=' text-dark-blue hover:text-sec-blue cursor-pointer'>Home</li></Link>
          <Link to='/about'><li className=' text-dark-blue hover:text-sec-blue cursor-pointer'>About</li></Link>
          <Link to='/profile'>
          {
            currentUser ? (
