        ...
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex gap-3 flex-wrap'>
            <div className='flex gap-2'>
              <input onChange={handleChange} type="checkbox" name="singles" className='w-5'  checked={formData.singles}/>
              <span>Singles</span>
            </div>
            <div className='flex gap-2'>
              <input onChange={handleChange} type="checkbox" name="sharing" className='w-5'  checked={formData.sharing}/>
              <span>Sharing</span>
            </div>
            <div className='flex gap-2'>
              <input onChange={handleChange} type="checkbox" name="male" className='w-5' checked={formData.male}/>
              <span>males</span>
            </div>
            <div className='flex gap-2'>
              <input onChange={handleChange} type="checkbox" name="female" className='w-5' checked={formData.female}/>
              <span>females</span>
            </div>
            <div className='flex gap-2'>
            ...
            <div className='flex gap-2'>
              <input onChange={handleChange} type="checkbox" name="swimmingpool" className='w-5'  checked={formData.swimmingpool}/>
              <span>Swimmingpool</span>
            </div>
            <div className='flex gap-2'>
              <input onChange={handleChange} type="checkbox" name="nsfas" className='w-5' checked={formData.nsfas}/>
              <span>Nsfas</span>
            </div>
            <div className='flex gap-2'>
              <input onChange={handleChange} type="checkbox" name="otherBursary" className='w-5'  checked={formData.otherBursary}/>
              <span>Bursary</span>
            </div>
            <div className='flex gap-2'>
              <input onChange={handleChange} type="checkbox" name="cashPaying" className='w-5' checked={formData.cashPaying}/>
          ...
          <div className='flex gap-4'>
            ...
            {formData.singles && (
                  <div className='flex items-center gap-2'>
                       ...
                       <input onChange={handleChange} type="number" name="singleRoomsNo" required className='p-2 w-[60px] border border-gray-300 rounded-lg' min="0" value={formData.singleRoomsNo}/>
...

             {
              formData.sharing && (
                <div className='flex items-center gap-2'>
                  ...
                  <input onChange={handleChange} type="number" name="sharingRoomsNo" required className='p-2 w-[60px] border border-gray-300 rounded-lg' min="0" value={formData.sharingRoomsNo}/>
            ...
            { formData.male && (
                        <div className='flex items-center gap-2'>
                          ...
                          <input onChange={handleChange} type="number" name="spaceLeftMales" required className='p-2 w-[60px] border border-gray-300 rounded-lg' min="0" value={formData.spaceLeftMales}/>
...

            {
              formData.female && (
                <div className='flex items-center gap-2'>
                  ...
                  <input onChange={handleChange} type="number" name="spaceLeftFemales" required className='p-2 w-[60px] border border-gray-300 rounded-lg' min="0" value={formData.spaceLeftFemales}/>
          ...
          <div className='flex gap-4 flex-wrap'>
            {
              formData.singles && (
                <div className='flex items-center gap-2'>
                   <input onChange={handleChange} type="number" name="singlesPrice" required className='p-2 w-[120px] border border-gray-300 rounded-lg' min="0"  value={formData.singlesPrice}/>
...

            {
              formData.sharing&& (
                <div className='flex items-center gap-2'>
                  <input onChange={handleChange} type="number" name="sharingPrice" required className='p-2 w-[120px] border border-gray-300 rounded-lg' min="0" value={formData.sharingPrice}/>
                  <div className='flex flex-col'>
